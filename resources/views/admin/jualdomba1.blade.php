 ...
 @section('content')
    <div class="layout-px-spacing"> 
            <div class="card m-3">
                ...
                <h5 class="card-title text-center">PENJUALAN DOMBA KE CUSTOMER</h5>
                </div>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  action="{{route('jual_selesai')}}" method="Post">    
                                    @csrf
       ...
       $.ajax({
                ...
                success: function(hsl) {
                 ...
                 if (hsl.status){
                     ...
                     html+='<thead><tr><th>No Registrasi</th><th>Berat Awal</th>';
                     html+='<th>Berat Akhir</th><th>Jenis</th><th>Kandang</th><th>Kamar</th>';
