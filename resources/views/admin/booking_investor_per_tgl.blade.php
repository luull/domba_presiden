    ...
    <div class="layout-px-spacing"> 
        <div class="row layout-top-spacing justify-content-center">
            <div class="card m-3">
                ...
                <h5 class="card-title text-center">DAFTAR BOOKING DOMBA </h5>
                </div>
                <div class="card-body p-2 pt-3">
                    <form  action="{{route('investor_order_list')}}" method="Post" enctype="multipart/form-data">    
                                    @csrf
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalLabel">Daftar Investor</h5>
