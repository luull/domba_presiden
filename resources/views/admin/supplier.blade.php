            ...
            <div class="modal-body">
                ...
                <form  action="{{route('create_supplier')}}" method="Post" enctype="multipart/form-data">    
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label>Jenis Supplier</label> <span class="text-danger">*</span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label>Propinsi</label> <span class="text-danger">*</span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label>Kota</label> <span class="text-danger">*</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label>Telp</label>
                                                <input type="text" name="telp" placeholder="Telp supplier" class="form-control" value="{{ old('telp') }}" >
                                                @error('telp')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="hp" placeholder="No Handphone supplier" class="form-control" value="{{ old('hp') }}" required>
                                                @error('hp')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label>Kontak</label> <span class="text-danger">*</span>
                ...
                <form  action="{{route('update_supplier')}}" method="Post" enctype="multipart/form-data">    
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label>Telp</label>
                                                <input type="text" name="telp" id="edit_telp" class="form-control" value="{{ old('telp') }}" >
                                                @error('telp')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label>No.Handphone</label> <span class="text-danger">*</span>
                                                <input type="text" name="hp" id="edit_hp" class="form-control" value="{{ old('hp') }}" required>
                                                @error('hp')
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
