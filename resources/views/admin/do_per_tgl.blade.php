                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Penerimaan Pakan</a></li>
                            </ol>
                        </nav>
    ...
    <div class="layout-px-spacing"> 
        <div class="row layout-top-spacing justify-content-center">
            <div class="card m-3">
                ...
                <h5 class="card-title text-center">DAFTAR PENERIMAAN PAKAN DARI SUPPLIER</h5>
                </div>
                <div class="card-body p-2 pt-3">
                    <form  action="{{route('do_per_tanggal')}}" method="Post" enctype="multipart/form-data">    
                                    @csrf
