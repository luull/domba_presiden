            ...
            <div class="card m-3">
                ...
                <div class="card-body p-2 pt-3">
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                        ...
                        <form  action="{{route('ubah_password_investor')}}" method="Post" enctype="multipart/form-data">    
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control input-default" name="old_password" id="old_password" >
